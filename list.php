...
<title>Harrier Car List Page</title>
...
<?php 
  ...
  {
    global $con;
    $get_car_list = "SELECT * FROM car_list";
    $run_get_car_list = mysqli_query($con, $get_car_list);
    while ($row_car_list = mysqli_fetch_array($run_get_car_list)) {
      $car_id = $row_car_list['car_id'];
      $car_name = $row_car_list['car_name'];
      $car_img = $row_car_list['car_img'];
      $car_des = $row_car_list['car_description'];
      $car_price = $row_car_list['car_price'];
      $car_rating = $row_car_list['car_rating'];
      echo "

        <div class='category-products'>
            <ol class='products-list' id='products-list'>
          <li class='item first'>
            <div class='product-image'> <a href='product-detail.html' title='HTC Rhyme Sense'> <img class='small-image' src='admin/$car_img' alt='HTC Rhyme Sense'> </a> </div>
            <div class='product-shop'>
              <h2 class='product-name'><a href='product-detail.html' title='HTC Rhyme Sense'>$car_name</a></h2>
              <div class='ratings'>
                <div class='rating-box'>
                  <div style='width:$car_rating'' class='rating'></div>
                </div>
                <p class='rating-links'> <a href='#/review/product/list/id/167/category/35/''>1 Review(s)</a>
              </div>
              <div class='desc std'>
                <p>$car_des</p>
              </div>
              <div class='price-box'>
                <p class='special-price'> <span class='price-label'></span> <span id='product-price-212' class='price'> $car_price </span> </p>
              </div>
              <div class='actions'>
                <a href='add_to_cart.php?id=$car_id'><button class='button btn-cart ajx-cart' title='Add to Cart' type='button'><span>Add to Cart</span></button></a>
              </div>
            </div>
          </li>
        </ol>
                ...
                <nav>
                  ...
                  <div class="nav-inner"> 
                    ...
                    <ul id="nav" class="hidden-xs">
                      ...
                      <li class="level0 parent drop-menu"> <a class="level-top" href="list.php"><span>Car Listing‎</span></a>
                        <ul class="level1">
